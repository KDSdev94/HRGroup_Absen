...
export const translations = {
  ...
  employees: {
    title: "Karyawan",
    subtitle: "Kelola data karyawan dan generate QR code",
    ...
    searchPlaceholder: "Cari berdasarkan nama, ID karyawan, atau divisi...",
    noEmployeesFound: "Tidak ada karyawan ditemukan. Tambahkan untuk memulai",
    confirmDelete: "Apakah Anda yakin ingin menghapus karyawan ini?",
    generateQR: "Generate QR",
    downloadQR: "Unduh QR",
    employeeIdCannotChange: "ID Karyawan tidak dapat diubah",
    selectDivision: "Pilih divisi",
    qrCodeTitle: "QR Code Karyawan",
    failedToAdd: "Gagal menambahkan karyawan",
    failedToUpdate: "Gagal memperbarui karyawan",
  ...
  dashboard: {
    title: "Dashboard",
    subtitle: "Ringkasan dan statistik kehadiran karyawan",
  ...
  attendance: {
    ...
    subtitle: "Lihat dan kelola catatan kehadiran karyawan",
    checkIn: "Check In",
    checkOut: "Check Out",
    date: "Tanggal",
    employee: "Karyawan",
    ...
    early: "Lebih Awal",
    onTime: "Tepat Waktu",
    filterByEmployee: "Filter berdasarkan karyawan",
  ...
  scan: {
    title: "Scan QR",
    subtitle: "Scan QR code karyawan untuk check in/out",
